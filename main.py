...
if __name__ == "__main__":
    ...
    conn_stats_agg_df.to_csv(f'./conn_stats_agg_df_{t0_str.replace(":","-")}_{num_days}day_Tag-{tag}_Band-{band}_SSID-{ssid}.csv')
    ...
    client_counts_df.to_csv(f'./client_counts_df_{t0_str.replace(":","-")}_{num_days}day_Tag-{tag}_Band-{band}_SSID-{ssid}.csv')
    ...
    latency_stats_df.to_csv(f'./latency_stats_df_{t0_str.replace(":","-")}_{num_days}day_Tag-{tag}_Band-{band}_SSID-{ssid}.csv')
    ...
    plt.tight_layout()
    plt.savefig(f'./conn_stats_agg_df_{t0_str.replace(":","-")}_{num_days}day_AP_Tag-{tag}_Band-{band}_SSID-{ssid}.png', dpi=1200)
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig(f'./client_counts_df_{t0_str.replace(":","-")}_{num_days}day_Tag-{tag}_Band-{band}_SSID-{ssid}.png', dpi=1200)
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig(f'./latency_stats_df_{t0_str.replace(":","-")}_{num_days}day_Tag-{tag}_Band-{band}_SSID-{ssid}.png', dpi=1200)
    plt.show()
